 ...
 * @pre `linear_system` is a continuous-time system. `time_period > 0`.
 *
 ...
 * @pre `affine_system` is a continuous-time system. `time_period > 0`.
 *
 * @tparam_default_scalar
 * @ingroup analysis
 */
 ...
 * @pre `system` is a continuous-time system. `time_period > 0`.
 ...
 * @warning The `system` reference must remain valid for the lifetime of the
 * returned system.
 *
 * @tparam_default_scalar
 * @ingroup analysis
